...
#		echo "<td>$r->username</td>";
		echo "<td>";
		$qFindLogons = query("SELECT company,COUNT(*) AS antall FROM loginlog WHERE clientname LIKE '$r->navn' OR hostname LIKE '$r->navn' GROUP BY company ORDER BY antall DESC");
		while($rFindLogons = fetch($qFindLogons)) {
			echo $rFindLogons->company."=".$rFindLogons->antall." ";
		}
		echo "</td></tr>";
		$i++;
	} // End whiler
