...
if($_SESSION['showmeny'] == 'skolenett') {
	...
	$submenu = '<li><a href=?module=graphs&amp;graphs=skolenett_logins_pr_uke>Pålogginger pr. uke</a>';
	...
	$submenu .= '<li><a href=?module=graphs&amp;graphs=skolenett_loginsprskole>Pålogginger pr. skole</a>';
...
$smarty->assign("Header", 'Hei pÃ¥ deg');
